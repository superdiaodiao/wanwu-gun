...
- <kbd>W</kbd> 前进，<kbd>S</kbd> 掉头，<kbd>A</kbd> / <kbd>D</kbd> 转向，<kbd>空格</kbd> 冲刺，<kbd>C</kbd> 切镜头，<kbd>Esc</kbd> 暂停。按住鼠标拖动也能转向。球不会倒着滚：想往回走就掉头。
- 手机上用左半边屏幕当摇杆（往上推前进，往两边推转弯，往回拉掉头），右边的「冲」是冲刺。画面卡的话会自动降低分辨率，也可以在开始页把「画质」调成低。
