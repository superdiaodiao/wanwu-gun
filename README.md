...
- 手机上用左半边屏幕当摇杆，往哪推球就往哪滚，往回拉会掉头；右边的「冲」是冲刺。画面卡的话会自动降低分辨率，也可以在开始页把「画质」调成低。
- 比球小的东西一碰就粘上，球随之长大；比球大的会把你弹开——撞一下会提示还差多少，等长大了再来。撞得太猛会掉东西。
- **边缘发金光的能滚，发红光的还差一点**，先绕开；附近最值钱的几样会闪一闪。一口气接着滚就是「连滚」，连得越长长得越快（最多 +40%）。每到一个目标尺寸会告诉你现在又能滚起哪些东西。
