...
- <kbd>W</kbd><kbd>A</kbd><kbd>S</kbd><kbd>D</kbd>（或方向键）往屏幕上哪个方向按，球就往哪滚，镜头会慢慢转到球后面；往回按是掉头，镜头跟着转过来。<kbd>空格</kbd> 冲刺，<kbd>C</kbd> 切镜头，<kbd>Esc</kbd> 暂停（暂停时看全图），按住鼠标拖动转镜头。
- 手机上左手用左半边屏幕当摇杆，往哪推球就往哪滚，往回拉会掉头；右手在屏幕其他地方左右滑动转镜头（两只手可以同时用），右下的「冲」是冲刺。画面卡的话会自动降低分辨率，也可以在开始页把「画质」调成低。开始页的「省电」（手机上默认打开）每秒画 30 帧而不是 60 帧，玩久了手机不容易发烫；想要更顺滑可以关掉。
