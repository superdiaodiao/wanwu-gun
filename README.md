...
- 手机上左手用左半边屏幕当摇杆，往哪推球就往哪滚：稍微偏一点只是轻轻拐弯，推到正侧面才直接往那边滚；推回正上方，球照现在的方向继续滚，镜头自己转到球后面；往回拉会掉头。右手在「冲」上方左右滑动转镜头（两只手可以同时用；还没用过的话，一直侧推摇杆转弯时那里会出现手指滑动的提示），右下的「冲」是冲刺。竖着拿手机时画面整体往上挪，球和推球的小人在屏幕中间、拇指上方，不会被手挡住。画面卡的话会自动降低分辨率，也可以在开始页把「画质」调成低。开始页的「省电」（手机上默认打开）每秒画 30 帧而不是 60 帧，玩久了手机不容易发烫；想要更顺滑可以关掉。
