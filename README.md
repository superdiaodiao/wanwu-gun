...
- <kbd>W</kbd> / <kbd>S</kbd> 推 / 拉，<kbd>A</kbd> / <kbd>D</kbd> 转向，<kbd>空格</kbd> 冲刺，<kbd>C</kbd> 切镜头，<kbd>Esc</kbd> 暂停。按住鼠标拖动也能转向；手机上用左下角摇杆和右边的「冲」。
...
- three.js r186 + esbuild 打包内联；所有物件按类型实例化渲染，静态的大物件按空间分块做视锥和雾距剔除。
